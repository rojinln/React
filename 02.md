...
Imperative programming is how you do something, and declarative programming is more like what you do. The imperative approach is concerned with how you’re actually going to get a seat. You need to list out the steps to be able to show how you’re going to get a table. The declarative approach is more concerned with what you want, a table for two.
